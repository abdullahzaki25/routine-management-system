<?php include "header.php"; ?>
 ...
 <form action="i-class-routine-p2.php" method="post">

	<p style="font-size:150%;">Insert Class Routine Information</p>
	...
	Code name of the teacher: <input type="text" name="cname"><br><br>
